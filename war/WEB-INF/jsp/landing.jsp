...
<tag:page dwr="WatchListDwr" js="view" onload="init">
  ...
  <jsp:body>
    <script type="text/javascript">
        ...
        if (welcomeDiv) {
            welcomeDiv.style.display = "block"; // This will ensure the div is visible
        }
    };
      ...
      function addPoint(point, parent) {
       ...
       "<img src='images/bullet_go.png' id='ph" + point.key + "Image' title='" +
       "${fn:escapeXml(i18n['watchlist.addToWatchlist'])}'/>",
                  object: point
          });
    ...
    <table width="100%">
    <tr><td>
       <div id="welcomeMessage" style="text-align:center; padding:10px;">
            <h1>Welcome</h1>
        </div>
