...
public class UserDao extends BaseDao {
   ...
   void updateUser(User user) {
        ...
        saveRelationalData(user);
            ...
            // Display error message using alert dialog if username or password is empty
            String errorMessage = "Error: Username and password are required.";
            // Generate JavaScript alert dialog to display the error message
            String alertScript = String.format("alert('%s');", errorMessage);

            System.out.println("Executing JavaScript: " + alertScript);
